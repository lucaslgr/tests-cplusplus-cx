...
void Rotacionar::MainPage::Button_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
void Rotacionar::MainPage::Grid_KeyDown(Platform::Object^ sender, Windows::UI::Xaml::Input::KeyRoutedEventArgs^ e)
{
...
void Rotacionar::MainPage::Canvas_KeyDown(Platform::Object^ sender, Windows::UI::Xaml::Input::KeyRoutedEventArgs^ e)
{
...
void Rotacionar::MainPage::Canvas_PointerPressed(Platform::Object^ sender, Windows::UI::Xaml::Input::PointerRoutedEventArgs^ e)
{

}


void Rotacionar::MainPage::Page_Loading(Windows::UI::Xaml::FrameworkElement^ sender, Platform::Object^ args)
{
	// Cria um objeto com rotação "0°" e insere no objeto. Isto tem que ser feito para todo objeto canvas
	// que puder ser rotacionado. Coloque já no construtor do objeto visual
	RotateTransform^ ang0 = ref new RotateTransform();
...
void Rotacionar::MainPage::Page_Loaded(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
void Rotacionar::MainPage::CNV2_KeyDown(Platform::Object^ sender, Windows::UI::Xaml::Input::KeyRoutedEventArgs^ e)
{
	//auto str = ref new String();
	//str = "aaaaa";
	//e->Handled = true;
...
void Rotacionar::MainPage::CNV2_PointerEntered(Platform::Object^ sender, Windows::UI::Xaml::Input::PointerRoutedEventArgs^ e)
{
